        ...
        <div className='w-[calc(100%-2rem)] flex flex-col'>
            <div className='flex items-center'>
                <div className='w-12 h-12 cursor-pointer flex flex-col'>
                    <img src="https://cdn.snappfood.ir/media/cache/vendor_logo/uploads/images/vendors/logos/5e425b4af195e.jpg" alt="resturant logo" className='w-full h-full rounded' />
                </div>
                <div className='mr-4 flex flex-col '>
                    <p className='cursor-pointer font-iransans font-bold text-sm inline-block text-carbon-main'>فست فود شیلا(تهرانپارس فلکه سوم)</p>
                    <div>
                        <p className='font-iransans text-xs inline-block text-carbon-main'>دوشنبه ۱۷ شهریور</p>
                        <p className='mr-4 font-iransans text-xs inline-block text-carbon-main'>۱۶:۵۲</p>
                    </div>
                </div>
            </div>
