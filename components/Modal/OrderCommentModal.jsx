'use client'
import { setHideCommentModal } from '@/redux/features/ShowModalSlice'
...
function OrderCommentModal() {
  ...
  const {isOpenOrderCommentModal}=showModal
  const dispatch=useDispatch()
  const handleClose=()=>{
    dispatch(setHideCommentModal())
  }
  if(!isOpenOrderCommentModal)return null;
        ...
        <div className='relative h-[40.25rem] bg-surface-main shadow-shadows-inset flex flex-col'>
          ...
          <div className='p-4 flex flex-col'>
            <div className='mb-6 flex justify-center items-center flex-col'>
              <p className='font-iransans font-bold text-lg inline-block text-carbon-main'>امتیاز به سفارش از فست فود شیلا (تهرانپارس فلکه سوم) </p>
              <div className='mt-1 flex'>
                <Image width={18} height={18} src={"/icons/modal/calender.svg"} alt='calender' className='ml-1'/>
                <p className='ml-8 font-iransans text-sm inline-block text-carbon-main'>دوشنبه، ۱۷ شهریور</p>
                <Image width={18} height={18} src={"/icons/modal/time.svg"} alt='time' className='ml-1'/>
                <p className='ml-8 font-iransans text-sm inline-block text-carbon-main'>۱۶:۵۲</p>
              </div>
            </div>
            <div className='relative box-border h-[9.75rem] my-4 p-2 border-surface-dark border rounded flex flex-col justify-center items-center'>
              ...
              <p className='my-2 font-iransans font-bold text-base inline-block text-carbon-main'>به سفارش‌تان از فست فود شیلا(تهرانپارس فلکه سوم) چه امتیازی می‌دهید؟</p>
              <div>
