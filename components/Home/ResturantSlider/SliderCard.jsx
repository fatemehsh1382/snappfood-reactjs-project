                    ...
                    <div className='mt-7 flex items-center flex-col'>
                        ...
                        <div className='mb-2'>
                            <div className='ml-2 flex'>
                                ...
                                <p className='font-iransans text-xs text-inactive-dark inline-block'>({separate(restaurant.totalPoints)} )</p>
                            </div>
                        </div>
                                    ...
                                    <div className='flex items-center'>
                                        <div className='flex flex-col items-start'>
                                            <span className='font-iransans font-bold text-xs text-carbon-main inline-block'> {separate(restaurant.delivery.price)}
                                                <span className='font-iransans font-normal text-xs text-carbon-main inline-block mr-1'>تومان</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
